...
def register(args):
    ...
    args["data"]["path_entry_name_content"]["path_" + args["path_entry_name"] + args["key"]] = {
        ...
        "_titlePlugin": args["self"].getName(),
    ...
    my=args["data"]["path_entry_name_content"]["path_" + args["path_entry_name"] + args["key"]]
    my["_titleName"]="dddd"
    my["path"]= args["path"]
    my["name"]= args["key"]
    my["type"]= args["self"].namePlugin
    my["title"]= args["self"].title
    my["_titlePlugin"]= args["self"].getName()
    my["key_menu_completion"]= key_menu_completion
    my #"content": args["configDict"][args["self"].namePlugin],
    my["tags"]= []
    my["preview"]=args["menu_completion"]
    my["description"]= "directory"
    my["titleIcon"]= args["self"].getTitleIcon()

    args["element"]["_titleName"]="ddd"
